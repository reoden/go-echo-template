...
import (
	...
	"github.com/reoden/go-echo-template/internal/catalogs/shared/app/application"
	"github.com/reoden/go-echo-template/internal/catalogs/shared/app/applicationbuilder"
...
func NewTestApp() *TestApp {
	viper.Set(constants.AppEnv, environment.Test.GetEnvironmentName())
	app := &TestApp{App: &App{}}
